    ...
    <div className="min-h-screen bg-black flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        ...
        <div className="flex justify-center mb-8">
          <svg width="140" height="28" viewBox="0 0 176 35" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="bg-[#111111] border border-[#2a2a2a] rounded-2xl p-7">
          ...
          {mode === 'login' ? (
            <>
              ...
              <p className="text-sm text-[#666666] mb-6">Acesse sua conta para continuar</p>
              ...
              <form onSubmit={handleLogin} className="space-y-4">
                <div>
                  <label className="text-xs text-[#888888] block mb-1.5">Email</label>
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full bg-[#1a1a1a] border border-[#2a2a2a] rounded-lg pl-9 pr-3 py-2.5 text-sm text-white placeholder-[#444444] focus:outline-none focus:border-orange-500/60 transition-colors"
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      required
                      placeholder="••••••••"
                      className="w-full bg-[#1a1a1a] border border-[#2a2a2a] rounded-lg pl-9 pr-10 py-2.5 text-sm text-white placeholder-[#444444] focus:outline-none focus:border-orange-500/60 transition-colors"
                    />
                    <button
                      type="button"
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full bg-orange-500 hover:bg-orange-400 disabled:opacity-50 disabled:cursor-not-allowed text-white font-medium py-2.5 rounded-lg text-sm flex items-center justify-center gap-2 transition-all"
                >
                  {loading ? (
            ...
            <>
              <button
                onClick={goToLogin}
                className="flex items-center gap-1 text-xs text-[#666666] hover:text-white mb-5 transition-colors"
              >
              ...
              {success ? (
                ...
                <form onSubmit={handleForgot} className="space-y-4">
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full bg-orange-500 hover:bg-orange-400 disabled:opacity-50 text-white font-medium py-2.5 rounded-lg text-sm flex items-center justify-center gap-2 transition-all"
                  >
                    {loading ? (
                      <span className="flex items-center gap-2">
                        <span className="w-4 h-4 border-2 border-white/30 border-t-white rounded-full animate-spin" />
                      ...
                      <><ArrowRight size={15} /> Enviar link</>
                    )}
                  </button>
                </form>
              )}
        ...
        <p className="text-center text-xs text-[#333333] mt-6">Gone Hub · Gestão de Tráfego Pago</p>
      </div>
    </div>
  )
}
